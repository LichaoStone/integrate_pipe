...
public class DateUtil {
     ...
     * @return
     */
    public static BaseEntity getBeginEndDate(String dateType,String module) {
    	Integer date=1;
		if (dateType!=null&&!"".equals(dateType)){
			date=Integer.parseInt(dateType);
		}
    	
    	String beginDate="";
		String endDate="";
		
		if (Constants.MODULE.SCLTJ.equals(module)) {
			switch (date) {
			case 0: //昨天
				beginDate=DateUtil.getBeforeOrNextDay(-1)+" 00:00:00";
				endDate=DateUtil.getBeforeOrNextDay(-1)+" 23:59:59";
				break;
			case 1: //最近七天 -生产力统计
				beginDate=DateUtil.getBeforeOrNextDay(-7)+" 00:00:00";
				endDate=DateUtil.getBeforeOrNextDay(-1)+" 23:59:59";
				break;
			case 2: //最近30天-生产力统计
				beginDate=DateUtil.getBeforeOrNextDay(-30)+" 00:00:00";
				endDate=DateUtil.getBeforeOrNextDay(-1)+" 23:59:59";
				break;
			case 3: //本月
				beginDate=DateUtil.getFirstDayOfMonth()+" 00:00:00";
				endDate=DateUtil.getTody()+" 23:59:59";
				break;
			default:
				break;
			}
		}else if (Constants.MODULE.RWTJ.equals(module)) {
			switch (date) {
				case 0: //昨天
					beginDate=DateUtil.getBeforeOrNextDay(-1)+" 00:00:00";
					endDate=DateUtil.getBeforeOrNextDay(-1)+" 23:59:59";
					break;
				case 1: //最近七天 -任务统计用
					beginDate=DateUtil.getBeforeOrNextDay(-6)+" 00:00:00";
					endDate=DateUtil.getTody()+" 23:59:59";
					break;
				case 2: //最近30天-任务统计用
					beginDate=DateUtil.getBeforeOrNextDay(-29)+" 00:00:00";
					endDate=DateUtil.getTody()+" 23:59:59";
					break;
				case 3: //本月
					beginDate=DateUtil.getFirstDayOfMonth()+" 00:00:00";
					...
					break;
				case 4: //今天-任务统计
					beginDate=DateUtil.getTody()+" 00:00:00";
					endDate=DateUtil.getTody()+" 23:59:59";
					break;
				default:
					break;
    	...
    	baseEntity.setBeginDate(beginDate);
    	baseEntity.setEndDate(endDate);
